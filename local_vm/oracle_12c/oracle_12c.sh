...
install_database_software(){
    ...
    wget -O /tmp/install_db.rsp https://raw.githubusercontent.com/a412316/test/master/local_vm/oracle_12c/db_install.rsp
    wget -O /tmp/netca.rsp https://raw.githubusercontent.com/a412316/test/master/local_vm/oracle_12c/netca.rsp
...
Create_database(){
    wget -O /tmp/dbca.rsp https://raw.githubusercontent.com/a412316/test/master/local_vm/oracle_12c/dbca.rsp
